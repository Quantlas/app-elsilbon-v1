        ...
        <div class="flex flex-column align-items-center justify-content-center">
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, rgba(33, 150, 243, 0.4) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style="border-radius: 53px">
                    ...
                    <div class="text-600 mb-5">Página no encontrada.</div>
                    <router-link to="/" class="w-full flex align-items-center py-5 border-300 border-bottom-1">
                        ...
                        <span class="ml-4 flex flex-column">
                            <span class="text-900 lg:text-xl font-medium mb-0 block">Vuelva a la página de inicio</span>
                            <span class="text-600 lg:text-xl">Aquí puede encontrar cosas increíbles.</span>
                        </span>
                    </router-link>
                    <router-link to="/" class="w-full flex align-items-center py-5 border-300 border-bottom-1">
                        ...
                        <span class="ml-4 flex flex-column">
                            <span class="text-900 lg:text-xl font-medium mb-0">Centro de ayuda</span>
                            <span class="text-600 lg:text-xl">Si está teniendo problemas comuníquese con nosotros.</span>
                        </span>
                    </router-link>
